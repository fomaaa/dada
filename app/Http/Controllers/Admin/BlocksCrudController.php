    ...
    public function setup()
    {
        ...
        */
        ...
        [
            ...
            'hide_when' => [
                0 => ['popup_video_link'],
                1 => ['show_this_block_head', 'show_this_block_video_type', 'this_block_video_link', 'this_block_video_url'],
            ],
            'default' => 0,
            'fake' => true,
            'store_in' => 'content',
        ...
        [
            ...
            'hide_when' => [
                0 => ['show_this_block_video_type', 'this_block_video_link']
       ...
       [
        ...
        [
            ...
            'hide_when' => [
                0 => ['video_preview', 'video_preview_type'],
                1 => ['image_preview'],
                2 => ['video_preview', 'video_preview_type', 'image_preview', 'link_preview']
            ],
            'default' => 0,
            'fake' => true,
            'store_in' => 'content',
